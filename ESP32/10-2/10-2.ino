...
void loop() {
  String a[3];
  int i = 0;
  String dateNtime;   //날짜와시간
  String pm10Val;     //10µg (미세먼지입자의의 크기),머리카락50~70 
  String pm10Grade;   //1: 좋음,2: 보통,3: 나쁨,4: 매우 나쁨
  String tmp_str;
  ...
  //<dataTime>, </dataTime>을 찾아 그 사이의 문자열을 dateNtime변수에 저장
  // pm10Value, pm10Grade 동일한 방법으로 추출하여 변수에 저장
...
//HTTP 요청 순서
//연결-> 요청전송->응답수신->데이터처리->연결종료
// GET 임의HTML데이터  HTTP/1.1\r\n
//Host: 웹주소 \r\n
//연경종료를 명시하는 Connection헤더추가 "Connection: close\r\n"
//HTTP요청의 끝 "r\n\r\n”
